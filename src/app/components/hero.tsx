      ...
      <div className="container md:flex-row flex-col mx-auto flex md:text-left px-4 md:px-9 py-20 ">
        ...
        <div className="animate2 mx-auto  text-center md:text-center md:w-[50%] mt-16 ">
          <h2 className="md:text-4xl text-3xl m-5 ">
            Hi I'm,   
            <span className="text-magenta text-3xl md:text-4xl "> KiranAhmed </span>
          </h2>

          <div className=" border-b-2 border-magenta  w-[30%] md:w-[40%] m-auto"></div>
          ...
          <button className="btn py-2 px-6 rounded-xl text-white  bg-magenta ">
            Hire ME
          </button>
        </div>
      </div>
